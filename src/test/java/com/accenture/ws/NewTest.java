...
private String baseUrl = "http://localhost:1010/kopeeteariaangular/";
...
driver.findElement(By.id("listOrderEditButton")).click();
Thread.sleep(1000);
// update feature
...
driver.findElement(By.id("editOrderSaveButton")).click();
Thread.sleep(1000);
...
Thread.sleep(4000);
driver.findElement(By.id("listOrderDeleteButton")).click();
...
driver.findElement(By.id("addOrderAddButton")).click();
}
